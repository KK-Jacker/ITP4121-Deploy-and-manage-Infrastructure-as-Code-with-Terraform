...
STACK_OUTPUT=../Azure/stack_output.json && \
...
kubectl create secret generic web-secret --from-literal='username=itp4121project@itp4121project2dev' --from-literal='password=123qweASD'  --from-literal='port=3306'  --from-literal='host=itp4121project2dev.mysql.database.azure.com' --from-literal='tablename=default_schema'
